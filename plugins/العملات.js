...
let minar = `${pickRandom([' 🩸 لقد جمعت عملات ايتاتشي🩸',
'🌟✨ عظيم!! حصلت ',
'واو!! أنت عامل منجم ⛏️ عظيم حصلت على',
'لقد حصلت!!',
'🗿 انت عرفت تجمع كميه كويسه',
'سوف يرتفع لفلك الاكسبي معه التعدين',
'⛏️⛏️⛏️⛏️⛏️ حصلت',
'🐦 جميل يا حب!!! الان لديك'])}`
...
if (new Date - user.lastcoins < 600000) return await conn.reply(m.chat, `*⏱️ تعاله بعد ${msToTime(time - new Date())} عشان تواصل الجمع ${global.rpgshopp.emoticon('money')}⛏️🐦🩸*`,  m)
...
let text = `*${premium ? '🎟️ مكافأة مميزة' : '🆓 مكافأة مجانية'}*\n*${minar}*\n*${money} ${global.rpgshop.emoticon('money')}*\n\n🍁 الاضافي\n${texto}\n\n🎟️ بريميوم ⇢ ${premium ? '✅' : '❌'}\n${wm}`
...
handler.help = ['minar2']
handler.tags = ['gata']
handler.command = ['عمله2', 'عمله4', 'عمله3', 'عمله5', 'عمله1', 'عمله6'] 
handler.fail = null
handler.exp = 0
