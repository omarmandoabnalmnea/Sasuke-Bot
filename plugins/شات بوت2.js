let handler = m => m 
 ...
     conn.reply(m.chat, `احترم نفسك`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 }   

   if (/^عبيط|يا عبيط |اهبل |غبي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `انت يروح بوت`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
   }
   
if (/^احمد كانكي$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `نأب ايتاتشي ❤️`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
}
 ...
     conn.reply(m.chat, `كل زق 🗿`, m) //wm, null, [['Menu', '#menu']], m) botones :V
 ...
     conn.reply(m.chat, `بلعب`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
 if (/^كيفك$/i.test(m.text) ) { //sem prefixo 
     conn.reply(m.chat, `الحمد الله وانت`, m) //wm, null, [['Menu', '#menu']], m) botones :V 
 ...
 if (/^كيفك|شخبارك|علوك|عامله ايه$/i.test(m.text) ) { //sem prefixo 
