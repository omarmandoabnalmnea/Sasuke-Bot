...
global.authFile = `MOHAMEDITACHI kun`
...
conn.welcome = '*╭━━━[ *شخص جديد ف الجروب* ]━━━━⬣*\n*╯─@subject*\n*╯─*\n*╯─@user*\n*╯─إنَّ اللهَ وَمَلَائِكَتَهُ يُصَلُّونَ عَلَى النَّبِيَّ يَا أَيُّهَا الَّذِينَ آمَنُوا صَلُّوا عَلَيْهِ وَسَلِّمُوا تَسْلِيمًا. مرحباً يروحي معاك/ي بوت اسمي ساسكي* \n*╯─*\n*╯─ وصف المجموعه:*\n\n@desc\n\n*╯─*\n*╯─ واتمنى ان تستمتع معنا بالمجموعه*\n*╰━━━〔 *🛡️ 1.5.0* 〕━━━━━⬣'
conn.bye = '*╭━━━[ *شخص غادر المجموعه * ]━━━━⬣\n*|_ @user*\n*╯─ يلا ف داهيا مش هتوحشنا 『⁦ಥ⁠‿⁠ಥ⁩ 』*\n╰━━━〔 *🛡️ 1.5.0* 〕━━━━━⬣'
conn.spromote = '*@user اصبح مشرف 👑!!*'
conn.sdemote = '*@user تم تنزيله من الاشراف 👀✔️!*'
...
let bio = `🤖 معلومات بسيطه عن البوت: ${uptime} ┃ ITACHI kun ┃ 🔗 جروب الدعم: https://chat.whatsapp.com/D1jV6CtduH7JMkWeyVoqou
اتمني لا احد يدخل له خاص`
